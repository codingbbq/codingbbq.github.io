...
![Visual Studio status bar message](/assets/images/vscode-status-message.jpg){:class="img-fluid w-100"}
...
![Visual Studio Status Error message](/assets/images/vscode-status-errormessage.jpg){:class="img-fluid w-100"}
