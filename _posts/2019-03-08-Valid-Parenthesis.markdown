...
excerpt : This is by far the most interesting problem I saw on leetcode. Also the algorithm to solve such challenge was super easy to understand and at the same time it was also super easy to implement. 
---
